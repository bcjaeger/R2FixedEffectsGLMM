...
* Set path to files ;
%LET PATH1=C:\Users\Byron\Desktop\School\Dissertation\SAS Code\;

* Set library for data ;
libname mylib "&PATH1\GLMM R2"; 

* Load the R2_beta macro ;
%inc "&PATH1\GLMM R2\Glimmix_R2_V3.sas"; 
...
* Predictors for Reduced Model ;
%LET Pred1 = X1i obstime;

* Predictors for Full Model ; 	
%LET Pred2 = X1i obstime X1i*obstime;	

* Covariance structure 1 ;
%LET Cov_1 = int;

* Covariance structure 2 ;	
%LET Cov_2 = int obstime;
